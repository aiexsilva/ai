...
class _ComponentsPageState extends State<ComponentsPage> {
  ...
  Widget build(BuildContext context) {
    final markers = [
      MapMarker(
        id: 'm1',
        coord: const Coordinate(lat: 40.6411, lng: -8.6520),
        label: 'Café',
      ),
      MapMarker(
        id: 'm2',
        coord: const Coordinate(lat: 40.6420, lng: -8.6510),
        label: 'Museu',
      ),
    ];
    final poly = [
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                AppButton(
                  label: 'Primária',
                  onTap: () => AppToast.show(context, 'Primária'),
                ),
                AppButton(
                  label: 'Ghost',
                  variant: AppButtonVariant.ghost,
                  onTap: () => AppToast.show(context, 'Ghost'),
                ),
                AppButton(
                  label: 'Outline',
                  variant: AppButtonVariant.outline,
                  onTap: () => AppToast.show(context, 'Outline'),
                ),
                AppButton(
                  label: 'Perigo',
                  variant: AppButtonVariant.danger,
                  onTap: () => AppToast.show(context, 'Danger'),
                ),
